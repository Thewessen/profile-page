<template>
  <article>
    <ArticleHeading
      title="Bowling"
      subtitle="JavaScript"
      github="https://github.com/Thewessen/hello-world/blob/master/Exercism/javascript/bowling" />
    <h3>The exercise</h3>
    ...
    <CodeHighlight
      v-if="solution"
      :startLineNumbers="20">{{ getLines(20, 36) }}</CodeHighlight>
    <p>
...
export default {
  ...
  apollo: {
    explenation: {
      query: gql`query {
        repository(owner: "Thewessen", name: "hello-world") {
          explenation: object(expression: "master:Exercism/javascript/bowling/README.md") {
            ... on Blob {
              text
            }
          }
    ...
    firstAttempt: {
      query: gql`query {
        repository(owner: "Thewessen", name: "hello-world") {
          attempt: object(expression: "master:Exercism/javascript/bowling/first-attempt.js") {
            ... on Blob {
              text
            }
          }
    ...
    solution: {
      query: gql`query {
        repository(owner: "Thewessen", name: "hello-world") {
          solution: object(expression: "master:Exercism/javascript/robot-name/robot-name.js") {
            ... on Blob {
              text
            }
          }
